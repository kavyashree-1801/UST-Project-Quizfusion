...
// Generate captcha only ONCE per page load
if (!isset($_SESSION['captcha_answer']) || empty($_SESSION['captcha_answer'])) {
    generate_captcha();
}
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    elseif (intval($captcha) !== intval($_SESSION['captcha_answer'])) {
        ...
        // CAPTCHA correct → clear previous data
        unset($_SESSION['captcha_answer'], $_SESSION['captcha_question']);
