...
if($role === 'admin' && isset($_GET['delete_id'])){
    ...
    $del_query = "DELETE FROM contact_messages WHERE id = $del_id";
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <?php if($role === 'admin'): ?>
                        <td>
                            <a class="delete-btn" href="manage_contact.php?delete_id=<?= $c['id'] ?>" onclick="return confirm('Are you sure to delete this message?');">Delete</a>
                        </td>
                    <?php endif; ?>
                </tr>
                <?php endforeach; ?>
